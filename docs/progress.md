...
-   :material-crown:{ .lg .middle } **Module 1: Leadership Briefing**
    ...
    ![Module 1 Badge](assets/badges/module-01-leadership.svg){ width="120" align="right" }
...
-   :material-foundation:{ .lg .middle } **Module 2: B-R Foundation**
    ...
    ![Module 2 Badge](assets/badges/module-02-foundation.svg){ width="120" align="right" }
...
-   :material-scale-balance:{ .lg .middle } **Module 3: Decision Support**
    ...
    ![Module 3 Badge](assets/badges/module-03-decision.svg){ width="120" align="right" }
...
-   :material-file-document-multiple:{ .lg .middle } **Module 4: Assessment Templates**
    ...
    ![Module 4 Badge](assets/badges/module-04-templates.svg){ width="120" align="right" }
...
-   :material-chart-bar:{ .lg .middle } **Module 5: Visualization Tools**
    ...
    ![Module 5 Badge](assets/badges/module-05-visualization.svg){ width="120" align="right" }
...
-   :material-briefcase:{ .lg .middle } **Module 6: Case Studies**
    ...
    ![Module 6 Badge](assets/badges/module-06-cases.svg){ width="120" align="right" }
...
-   :material-bullseye-arrow:{ .lg .middle } **Module 7: Competency Assessment**
    ...
    ![Module 7 Badge](assets/badges/module-07-competency.svg){ width="120" align="right" }
...
-   :material-shield-check:{ .lg .middle } **Module 8: Regulatory Reference**
    ...
    ![Module 8 Badge](assets/badges/module-08-regulatory.svg){ width="120" align="right" }
...
<div style="text-align: center; margin: 2rem 0;">
    <img src="assets/badges/toolkit-master.svg" alt="Toolkit Master Badge" width="200" style="opacity: 0.3;"/>
    <p><em>Complete all modules to unlock this badge</em></p>
</div>
