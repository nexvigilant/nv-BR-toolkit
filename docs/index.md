...
[![CI](https://github.com/nexvigilant/nv-BR-toolkit/actions/workflows/ci.yml/badge.svg)](https://github.com/nexvigilant/nv-BR-toolkit/actions/workflows/ci.yml)
...
```mermaid
graph LR
    A[Leadership Briefing] --> B[Foundation Module]
    B --> C[Decision Support]
    C --> D[Assessment Templates]
    D --> E[Case Studies]
    E --> F[Visualization Tools]
    F --> G[Competency Assessment]
```
