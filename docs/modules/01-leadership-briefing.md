...
```mermaid
flowchart TB
    subgraph CIOMS["CIOMS WG XII Key Recommendations"]
        A["1️⃣ STRUCTURED FRAMEWORK<br/>Use systematic approaches to<br/>organize B-R information"]
        B["2️⃣ TRANSPARENCY<br/>Document decision rationale<br/>clearly and consistently"]
        C["3️⃣ STAKEHOLDER INPUT<br/>Include patient perspectives<br/>in B-R evaluation"]
        D["4️⃣ LIFECYCLE APPROACH<br/>Continuous reassessment<br/>as new data emerges"]
        E["5️⃣ QUANTIFICATION<br/>Use appropriate methods<br/>to support but not replace judgment"]
    end
...
```mermaid
flowchart LR
    A[1. Decision<br/>Context] --> B[2. Identify<br/>Outcomes]
    B --> C[3. Data<br/>Sources]
    C --> D[4. Outcome<br/>Importance]
    D --> E[5. Outcome<br/>Probability]
    E --> F[6. Integrate<br/>B-R]
```
